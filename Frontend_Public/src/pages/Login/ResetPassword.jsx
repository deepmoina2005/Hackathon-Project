...
const ResetPassword = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen  bg-gradient-to-br from-blue-200">
      {/* <img
        onClick={() => navigate("/")}
        src={assets.logo}
        alt=""
      ...
      <div className="mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]">
        ...
        <input type="text" placeholder="Email id" className="bg-transparent outline-none text-white" value={email} onChange={e => setEmail(e.target.value)} required/>
      </div>
      ...
      <form onSubmit={onSubmitOtp} className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
              ...
              <div className='flex justify-between mb-8' onPaste={handlePaste}>
                {Array(6).fill(0).map((_, index)=> (
                  <input type="text" max='1' key={index} required
